    ...
    <head>
        ...
        <header>
            ...
            <div class="modal-header" style="background-color: #255625; color: white">
                <div class="col-md-12"><!----><h5 style="text-align: center"><a class="navbar-brand" href="../TelaPrincipalADM.php">Home</a>Sistema de Gestão de Viagens Institucionais - Alterar dados de usuário</h5></div></div>
              ...
              <div class="col-md-12">
               ...
               <div class="col-md-12">
                ...
                <div class="col-md-6">
                  <div class="col-md-2">
                    <br>
                    <label for="i3" value="Senha:">Nova senha:  </label>
                  </div>
                  <div class="col-md-10">
                    <br>
