...
$sql=mysqli_query($connect, "select * from usuario inner join tipo_usuario on tipo_usuario=id_tipo_usuario where status_usuario=0 ");

if (isset($_POST['pesquisa'])) {
    $pesquisa=$_POST['pesquisa'];

  $sql=mysqli_query($connect,"select * from usuario inner join tipo_usuario on tipo_usuario=id_tipo_usuario where status_usuario=0 and nome_usuario LIKE '%$pesquisa%' or status_usuario=0 and login_usuario LIKE '%$pesquisa%'") or die(mysql_error());;
}
...
<header>
    ...
    <div class="row" style="background-color: #255625;
           color: white">
          <div class="col-md-12" ><!----><h5 style="text-align: center" class="text-center">Sistema de Gestão de Viagens Institucionais - Usuários cadastrados</h5></div></div>
