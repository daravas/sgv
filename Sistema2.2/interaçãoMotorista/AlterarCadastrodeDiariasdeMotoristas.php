...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Alterar Cadastro Diárias de Motoristas</title>
    ...
    border-color:black;
        ...
        <header>
            ...
            <div class="modal-header" style="background-color: #255625; color: white">
                <div class="col-md-12"><!---->
                    <h5 style="text-align: center"><a class="navbar-brand" href="../TelaPrincipalADM.php">Home</a>Sistema de Gestão de Viagens Institucionais - Alterar Cadastro Diárias de Motoristas</h5></div></div>
