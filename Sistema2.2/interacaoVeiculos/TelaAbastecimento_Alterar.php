    ...
    border-color:black;
        ...
        <header>
            ...
            <div class="modal-header" style="background-color: #255625; color: white">
                <div class="col-md-12"><!---->
                    <h5 style="text-align: center"><a class="navbar-brand" href="../TelaPrincipalADM.php">Home</a>Sistema de Gestão de Viagens Institucionais - Alterar dados de abastecimento </h5></div></div>
            ...
            <form method="post">
                  <div class="col-md-12">
                   ...
                   <div class="col-md-12">
                           ...
                           <div class="col-md-4">
                           <br>
                           <input class="form-control" type="text" id="i3" class="input-texto" value="" placeholder="quilometragem" name="campoQuilometragem">
                           </div>
                                     <div class="col-md-2">
                                     <br>
                                     ...
                                     <div class="col-md-4">
                                     <br>
                                     <input class="form-control" type="text" id="i4" class="input-texto" value="" placeholder="quantidade" name="campoQuantidade">
                                     </div>
                   </div>
