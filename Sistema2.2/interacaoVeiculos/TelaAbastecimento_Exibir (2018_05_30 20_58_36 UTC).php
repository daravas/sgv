...
<header>
    ...
    <div class="modal-header" style="background-color: #255625; color: white">
        <div class="col-md-12"><!----><h5 style="text-align: center">
                <a class="navbar-brand" href="../TelaPrincipalADM.php">Home</a>Sistema de Gestão de Viagens Institucionais - Abastecimentos registrados</h5>
                </div></div>
</header>
      ...
      <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
          ...
          <div class="col-md-1 pull-left"></div>
                  ...
                  <div class="col-md-1 pull-left">
                    <br><br>
                    <a href="../interacaoVeiculos/TelaAbastecimento_Cadastrar.php" type="submit" class="btn btn-success">Novo</a>
                    <br><br>
                  </div>
