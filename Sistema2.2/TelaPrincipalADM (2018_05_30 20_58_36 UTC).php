    ...
    <body>
         ...
         <img src="imagens/logoifba.png" class="img-responsive" alt="Imagem Responsiva">
          <div class="modal-header" style="background-color: #255625; color: white">
             <div class="col-md-12"><!----><h5 style="text-align: center">Sistema de Gestão de Viagens Institucionais<a class="navbar-brand" href="login/logoff.php">Sair</a></h5>
                 </div></div>
       ...
       <div class="col-md-10 ">
         ...
         <div class="row">
            <div class="col-md-3">
             ...
             <div class="dropdown alert-success">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"><br>
                <a class="dropdown-item" style="color:#000000;" href="#">Agendadas</a><br><br>
                <a class="dropdown-item" style="color:#000000;" href="#">Registrar nova</a><br>
              </div>
              </div></div>
            </div>
           ...
           <div class="col-md-3">
             ...
             <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"><br>
               ...
               <a class="dropdown-item" style="color:#000000;"href="#">Diárias</a><br>
           ...
           <div class="col-md-3">
             ...
             <div class="dropdown-menu" style="color:#000000;" aria-labelledby="dropdownMenuButton"><br>
               ...
               <a class="dropdown-item" style="color:#000000;" href="#">Relatório de Status de Veículos</a><br>
             </div>
             </div></div>
           </div>
         ...
         <div class="row">
           ...
           <div class="col-md-2">
                <div class="btn-group">
             <div class="dropdown">
             <input type="image" src="imagens/usuarios1.png"  style="cursor: pointer" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
             <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"><br>
               <a class="dropdown-item" style="color:#000000;" href="interacaoUsuario/TelaCadastrarUsuario.php">Novo</a><br><br>
               <a class="dropdown-item" style="color:#000000;" href="interacaoUsuario/TelaUsuarios_Exibir.php">Cadastrados</a><br>
             </div>
             </div></div>
         </div>
